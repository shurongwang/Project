...
if init:
	...
	#	rel_init_emb[r] /= rel_cnt[r]
	#
	ent_init_emb = F.normalize(ent_init_emb)
	#rel_init_emb = F.normalize(rel_init_emb)

	# print(rel_init_emb, rel_init_emb.size())
